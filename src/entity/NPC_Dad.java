...
public class NPC_Dad extends Entity {
    ...
    public void setDialogue() {
        ...
        dialogues[9] = "Don't be using \"Constant\" on't heater in case\nyou forget to turn it off!";
        ...
        dialogues[15] = "That Truss won't be any good, we need Labour\nin!!";
        dialogues[16] = "grumble...energy costs...grumble...";
        dialogues[17] = "I'm not going up there doing that all day...";
        dialogues[18] = "Baldilocks has gone on another cruise I see...";
        dialogues[19] = "I'm just gonna sit in't garden!";
        dialogues[20] = "Sharon, I were looking at these on eBay,\nwhat you think??";
        dialogues[21] = "Meggy's getting rid of a cement mixer, only\nwants eighty quid for it...";
        dialogues[22] = "You should cover that camera up with this\ngaffer tape...";
        dialogues[23] = "Bloody Chinese listening in, have you seen\nthis advert...";
        dialogues[24] = "Tell you what, you won't be having all them\nholidaysbafter this electric goes up!";
        dialogues[25] = "What did you say to Pete Squeeze last neyt?\nHe seemed a bit off...";
        dialogues[26] = "That bloody tosser next door needs to fix\nthat fence!";
        dialogues[27] = "Need some new strings for this guitar...";
        dialogues[28] = "When's our Leigh over...Not staying all\n month or owt is he?!";
        dialogues[29] = "I can't park my bloody car outside my own\nhouse f'that t&@t next door!";
        ...
        dialogues[47] = "I've seen a reyt bloody good guitar on eBay...";
        dialogues[48] = "There's a draught coming in under that door...";
        dialogues[49] = "Just you watch, petrol and th'electric'll\nstay high even after their war excuses finish!";
        dialogues[50] = "Smart TV? I wun't ha' one ginn!";
        dialogues[51] = "She's a face like a bulldog chewin' a wasp!";
        dialogues[52] = "All this Putin...Bet ya owt ya want its\nbloody government and't AmUrricans cashin' in!";
        ...
        dialogues[55] = "There were some bloody kids looking sheepish\nround't back when I went up...";
        ...
        dialogues[58] = "Where's old Fleabag??";
    }
